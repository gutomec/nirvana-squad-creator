...
// Uso: node bin/squad-tools.cjs <comando> [args]
...
function main() {
  ...
  if (args.length === 0) {
    console.log(`squad-tools.cjs — CLI de estado atômico para o pipeline de squads
...
Comandos:
  ...
  validate <session> --phase=N                         Validar outputs esperados por fase
